/*  $Id: build_db.cpp 208050 2010-10-13 15:48:11Z maning $
* ===========================================================================
*
...
static char const rcsid[] = "$Id: build_db.cpp 208050 2010-10-13 15:48:11Z maning $";
    ...
    : m_FastaReader(NULL)
{
    ...
    int iflags = CFastaReader::fAllSeqIds | CFastaReader::fForceType;
