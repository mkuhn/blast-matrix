/* $Id: ncbi_lbsm.c 208743 2010-10-20 17:45:32Z lavr $
 * ===========================================================================
 *
...
const SLBSM_Host* LBSM_LookupHost(HEAP heap, unsigned addr,
