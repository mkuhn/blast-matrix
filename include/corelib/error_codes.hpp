...
/*  $Id: error_codes.hpp 183966 2010-02-23 18:14:19Z ivanovp $
 * ===========================================================================
 *
...
NCBI_DEFINE_ERRCODE_X(Corelib_App,        106, 19);
NCBI_DEFINE_ERRCODE_X(Corelib_Diag,       107, 23);
...
NCBI_DEFINE_ERRCODE_X(Corelib_TestBoost,  119,  3);
